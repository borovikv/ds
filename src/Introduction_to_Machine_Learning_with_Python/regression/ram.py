...
ram_prices = pd.read_csv("~/Downloads/ram_price.csv", index_col=0)
...
methods = [LinearRegression, DecisionTreeRegressor, (RandomForestRegressor, dict(n_estimators=500, random_state=2))]
